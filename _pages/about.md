...
<li>
  <div style="display: flex; align-items: flex-start; gap: 15px;">
    <div style="position: relative; display: inline-block; width: 100%; max-width: 1000px;">
        ...
        <img src="../images/phishllm-thumb.png" alt="Thumbnail" style="width: 50%; max-width: 1000px; height: auto; border: 1px solid #ddd; border-radius: 5px; box-shadow: 4px 4px 10px rgba(0, 0, 0, 0.2);">
      </div>
    <div>
